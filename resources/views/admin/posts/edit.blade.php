        ...
        <div class="col-12">
            ...
            <form action="{{ route('posts.update', ['post' => $post->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Titolo</label>
                    <input type="text" name="titolo" class="form-control @error('titolo') is-invalid @enderror" placeholder="Inserisci il titolo" value="{{ old('titolo', $post->titolo) }}" required>
                    @error('titolo')
                ...
                <div class="form-group">
                    ...
                    <textarea name="contenuto" class="form-control @error('contenuto') is-invalid @enderror" rows="10" placeholder="Inizia a scrivere qualcosa..." required>{{ old('contenuto', $post->contenuto) }}</textarea>
                    @error('contenuto')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
